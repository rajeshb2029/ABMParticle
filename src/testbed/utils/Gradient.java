...
// Taken from https://code.google.com/p/piccolo2dtouch/source/browse/trunk/Piccolo2D_Touch/src/edu/purdue/touch/util/Gradient.java?r=3
...
public class Gradient {
  ...
  /**
   * @author Rajesh
   * Produces gradient through JetMap (MATLAB): blue, green, yellow, orange, red
   */
  public final static Color[] GRADIENT_JETMAP = createMultiGradient(new Color[]{Color.blue, Color.green, Color.yellow, Color.orange, Color.red}, 500);
